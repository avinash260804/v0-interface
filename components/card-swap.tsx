...
// ---------------------------------------------------------------------------
// Helpers (ported exactly from react-bits CardSwap source)
// ---------------------------------------------------------------------------
...
export default function CardSwap({
  ...
  const rendered = childArr.map((child, i) =>
    isValidElement(child)
      ? cloneElement(child as React.ReactElement<React.HTMLAttributes<HTMLDivElement> & { ref?: React.Ref<HTMLDivElement> }>, {
          key: i,
          ref: refs[i],
          style: {
            width,
